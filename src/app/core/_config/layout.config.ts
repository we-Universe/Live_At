	...
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				...
				dark: 'https://www.myclinic.com.my/wp-content/uploads/2019/05/logo-color2x.png',
				light: './assets/media/logos/logo-dark.png',
				brand: 'https://www.myclinic.com.my/wp-content/uploads/2019/05/logo-color2x.png',
				// brand: './assets/media/logos/logo-light.png',
				green: 'https://www.myclinic.com.my/wp-content/uploads/2019/05/logo-color2x.png',
